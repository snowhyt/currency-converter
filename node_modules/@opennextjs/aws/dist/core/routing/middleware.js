import { FunctionsConfigManifest, MiddlewareManifest, NextConfig, } from "../../adapters/config/index.js";
...
import { convertBodyToReadableStream, convertToQueryString, getMiddlewareMatch, isExternal, } from "./util.js";
...
export async function handleMiddleware(internalEvent, middlewareLoader = defaultMiddlewareLoader) {
