 ...
 * @returns
 */
export function openNextEdgePlugins({ nextDir, middlewareInfo, isInCloudfare, }) {
    const entryFiles = middlewareInfo?.files.map((file) => path.join(nextDir, file)) ?? [];
