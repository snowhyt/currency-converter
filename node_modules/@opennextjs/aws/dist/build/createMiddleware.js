...
import { loadFunctionsConfigManifest } from "../adapters/config/util.js";
...
export async function createMiddleware(options, { forceOnlyBuildOnce = false } = {}) {
    ...
    if (!edgeMiddlewareInfo) {
        ...
        const functionsConfigManifest = loadFunctionsConfigManifest(path.join(appBuildOutputPath, ".next"));
